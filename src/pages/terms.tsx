    ...
    <>
      ...
      >
        ...
        <Box>
          ...
          その他，管理人が不適切と判断する行為 第6条（本サービスの提供の停止等）
        ...
        <Heading>第7条（利用制限および登録抹消）</Heading>
        <Box>
        ...
        <Heading>第8条（退会）</Heading>
        <Box>
          ユーザーは，管理人の定める退会手続により，本サービスから退会できるものとします。
        </Box>
        <Heading>第9条（保証の否認および免責事項）</Heading>
        <Box>
